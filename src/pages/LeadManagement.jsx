...
const LeadManagement = () => {
  ...
  }, [searchTerm, filterTags, filterSalesMember, filterBranch, filterDate, currentPage, token]);
    ...
    <div className="p-6 animate-fade-in max-w-7xl mx-auto">
      ...
      >
        <div className="flex w-full md:w-auto gap-3 flex-1 max-w-4xl flex-wrap md:flex-nowrap">
          ...
          />
          <div className="relative w-full md:w-44" ref={tagDropdownRef}>
            <button
              type="button"
            ...
            <form onSubmit={handleBulkUploadSubmit} className="p-6">
              ...
              <div className="mb-6 p-4 rounded-xl text-xs space-y-1.5" style={{ backgroundColor: `${themeColors.primary}10`, color: themeColors.text }}>
                ...
                <ul className="list-disc pl-4 space-y-1.5 opacity-90">
                  <li><b style={{ color: themeColors.primary }}>phone:</b> Required field.</li>
                  ...
                  <li><b style={{ color: themeColors.primary }}>name, tags, remark, source, email:</b> Optional free text fields.</li>
                </ul>
              </div>
